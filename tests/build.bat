...
ffmpeg -hide_banner -loglevel error -y -framerate 30 -i stack_%%05d.ppm -c:v libx264 -pix_fmt yuv420p stack.mp4
ffmpeg -hide_banner -loglevel error -y -framerate 30 -i cube_%%05d.ppm -c:v libx264 -pix_fmt yuv420p cube.mp4
ffmpeg -hide_banner -loglevel error -y -framerate 30 -i teddy_%%05d.ppm -c:v libx264 -pix_fmt yuv420p teddy.mp4
ffmpeg -hide_banner -loglevel error -y -framerate 30 -i voxel_teddy_%%05d.ppm -c:v libx264 -pix_fmt yuv420p voxel_teddy.mp4
ffmpeg -hide_banner -loglevel error -y -framerate 30 -i voxel_head_%%05d.ppm -c:v libx264 -pix_fmt yuv420p voxel_head.mp4
REM 
